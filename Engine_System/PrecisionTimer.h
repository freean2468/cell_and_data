...
//
//----------------------------------------------------------------------------
inline bool CPrecisionTimer::ReadyForNextFrame()
{
  assert(m_NormalFPS && "CPrecisionTimer::ReadyForNextFrame<No FPS set in timer>");
...
//-------------------------------------------------------------------------
inline double CPrecisionTimer::TimeElapsed()
{
