#ifndef _FileLoaderBase_H_
#define _FileLoaderBase_H_

#pragma warning(disable:4800)
//------------------------------------------------------------------------
//
//  Name: CFileLoaderBase.h
//  
...
public:
	CFileLoaderBase(const char* _pstrFilename):CurrentLine(""), m_bGoodFile(true){
		file.open(_pstrFilename);
...
public:
	...
	std::string GetNextScriptAsString(){if(m_bGoodFile) return GetNextScript(); throw std::runtime_error("bad file");}
